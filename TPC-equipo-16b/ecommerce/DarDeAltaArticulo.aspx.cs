...
namespace ecommerce
{
    public partial class DarDeAltaArticulo : System.Web.UI.Page
    {
        ...
        protected void BotonDarDeAlta_Click(object sender, EventArgs e)
        {
            int IdArticulo;
            if (int.TryParse(ddlArticulos.SelectedValue, out IdArticulo))
            {
                NegocioArticulo.DarDeAltaArticulo(IdArticulo);
                lblMensaje.Text = "Artículo dado de alta con éxito.";
