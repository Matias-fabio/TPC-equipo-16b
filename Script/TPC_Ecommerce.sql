...
CREATE TABLE PRECIO_ENVIOS (
    ...
    CONSTRAINT PK_PRECIO_ENVIOS PRIMARY KEY (idZona)
);
GO
...
CREATE TABLE CUPONES (
    ...
    Descuento INT NULL,
    CONSTRAINT PK_CUPONES PRIMARY KEY (CodigoCupon)
);
GO
...
INSERT INTO MARCAS (Nombre, Logo) VALUES
('Redragon', 'https://redragon.es/content/uploads/2021/04/logo.png'),
('Logitech', 'https://resource.logitechg.com/w_692,c_lpad,ar_4:3,q_auto,f_auto,dpr_1.0/d_transparent.gif/content/dam/logitech/logitech-logo.png?v=1'),
('Samsung', 'https://images.samsung.com/is/image/samsung/logo'),
('Corsair', 'https://www.corsair.com/img/logo.svg'),
('AMD', 'https://upload.wikimedia.org/wikipedia/commons/8/8e/AMD_Logo.svg'),
('Gigabyte', 'https://static.gigabyte.com/StaticFile/Image/Global/163e9f51ab41e2b931919e1dde162c0a/Logo'),
('Level Up', 'https://levelupworld.com/assets/img/level-up-logo.png'),
('AeroCool', 'https://aerocool.io/wp-content/uploads/2021/03/logo-750.png'),
('Western Digital', 'https://www.westerndigital.com/content/dam/store/en-us/assets/global/images/wd-logo.png'),
('Intel', 'https://upload.wikimedia.org/wikipedia/commons/c/c9/Intel-logo.svg'),
('Aorus', 'https://app.contabilium.com/files/explorer/7026/Productos-Servicios/aorus-logo.png'),
('ASUS', 'https://dlcdnwebimgs.asus.com/gain/logo.png'),
('Cooler Master', 'https://www.venex.com.ar/products_images/1678372857_cooler-master.png'),
('Mackie', 'https://cdnx.jumpseller.com/guitarstore/image/18133102/mackie-logo.png'),
('TP-LINK', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMScoTNQfyQHFEktZYG6xhfdJ1pWCc0OSSug&s');
GO
